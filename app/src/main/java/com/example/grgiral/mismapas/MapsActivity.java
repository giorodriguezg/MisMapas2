...
//        mMap.addMarker(new MarkerOptions().position(sydney).title("Marker in"));
        ...
        mMap.addMarker(new MarkerOptions().position(sydney).title("Ubicado en"+ descripcion).snippet(descripcion).icon(BitmapDescriptorFactory.fromResource(R.drawable.icons8_marker_480)));
